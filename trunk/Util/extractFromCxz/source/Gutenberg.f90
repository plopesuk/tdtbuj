...
contains
  ...
  subroutine PrintCurrents(cxz,unitout)
    ...
    integer :: i
     ...
     write(unitout,'(a,i0,1x,a1,2a2,a,3f12.8)')"#Bond current between atom ",cxz%atom1, "(",cxz%element1,") ","position: ", cxz%x1,cxz%y1,cxz%z1
     write(unitout,'(a,i0,1x,a1,2a2,a,3f12.8)')"#and atom ",cxz%atom2, "(",cxz%element2,") ","position: ", cxz%x2,cxz%y2,cxz%z2
