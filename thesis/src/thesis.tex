...
\usepackage{multirow}
\usepackage{cancel}   %cancels terms in equations
...
\tdesc{A thesis  submitted to the \emph{School of Mathematics and Physics}\\in partial fulfilment
of the requirements for the degree of\\ \emph{Doctor of Philosophy}}
